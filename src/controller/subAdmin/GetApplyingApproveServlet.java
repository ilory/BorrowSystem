...
@WebServlet("/getApplying")
public class GetApplyingApproveServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Person_Equipment personEquipment = new Person_Equipment(null,null,null,null,1,null,null);
